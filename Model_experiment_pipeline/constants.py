DB_PATH = '/home/sryarra/airflow/dags/Model_experiment_pipeline/'
DB_FILE_NAME = 'model_experiment_data_cleaning.db'

DATA_DIRECTORY = '/home/sryarra/airflow/dags/Model_experiment_pipeline/data/'

INTERACTION_MAPPING = '/home/sryarra/airflow/dags/Model_experiment_pipeline/interaction_mapping.csv'

TRACKING_URI = "http://0.0.0.0:8090"

MODEL_NAME = "LightGBM"

EXCLUDE_MODEL = ['gbc','knn','qda', 'dummy', 'svm', 'ada']
...
SIGNIFICANT_FEATURES = ['total_leads_droppped', 'city_tier', 'referred_lead', 'first_platform_c', 'first_utm_medium_c', 'first_utm_source_c', 'app_complete_flag']
